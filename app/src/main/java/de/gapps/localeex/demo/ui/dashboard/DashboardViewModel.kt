package de.gapps.localeex.demo.ui.dashboard
...
class DashboardViewModel : ViewModel() {
    ...
    private val _actText = MutableLiveData<String>().apply {
        value = MainActivity.activity.getString(R.string.dashboard_fragment_message)
    }
    val actText: LiveData<String> = _actText

    private val _appText = MutableLiveData<String>().apply {
        value = MainApplication.application.getString(R.string.dashboard_fragment_message)
    }
