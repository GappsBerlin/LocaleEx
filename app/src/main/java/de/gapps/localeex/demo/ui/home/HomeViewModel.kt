package de.gapps.localeex.demo.ui.home
...
class HomeViewModel : ViewModel() {
    ...
    private val _actText = MutableLiveData<String>().apply {
        value = MainActivity.activity.getString(R.string.home_fragment_message)
    }
    val actText: LiveData<String> = _actText

    private val _appText = MutableLiveData<String>().apply {
        value = MainApplication.application.getString(R.string.home_fragment_message)
    }
